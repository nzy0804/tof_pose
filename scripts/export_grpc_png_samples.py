...
def main() -> None:
    ...
    for idx, result in enumerate(resp.results, start=1):
        ...
        lines.append(
            ...
            f"{len(result.skeleton_contour_image)} | {result.person_count} |"
        )
